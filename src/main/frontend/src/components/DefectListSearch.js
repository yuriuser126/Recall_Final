...
function DefectListSearch({ searchCriteria, onSearchChange, onSearchSubmit }) {
    return (
        <form onSubmit={onSearchSubmit} className="uk-form-stacked" style={{ marginBottom: '20px' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '10px', justifyContent: 'center' }}>
                <select name="type" className="uk-select uk-form-width-small" value={searchCriteria.type} onChange={onSearchChange}>
...
export default DefectListSearch; // 내보내는 이름도 변경